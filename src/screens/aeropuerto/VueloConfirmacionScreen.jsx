    ...
    <div className="screen center">
      <div className="boarding-pass">
        <div className="boarding-head">
          <span className="boarding-airline">Inclusive Airlines</span>
        ...
        <div className="boarding-route">
          ...
          <span className="boarding-plane" aria-hidden="true">✈</span>
          <div>
        ...
        <div className="boarding-details">
          <div>
            ...
            <span>{reserva.ida.hora} · {reserva.ida.vuelo}</span>
            <span className="row-sub">Puerta {reserva.ida.puerta} · {reserva.ida.terminal}</span>
          </div>
          {reserva.vuelta && (
            <div>
              <span className="meta-label">Vuelta</span>
              <strong>{formatFechaLarga(new Date(reserva.vuelta.fecha))}</strong>
              <span>{reserva.vuelta.hora} · {reserva.vuelta.vuelo}</span>
            </div>
          )}
        </div>
